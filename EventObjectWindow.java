...
/**
 * This is Code Listing 12-8.
 * This class demonstrates how to retrieve the action
 * command from an event object.
 * 
 * @author craig
 */
	...
	private class ButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (actionCommand.equals("Button 1")) {
				...
				JOptionPane.showMessageDialog(null, "You "
					+ "clicked the second button.");
			} else if (actionCommand.equals("Button 3")) {
				JOptionPane.showMessageDialog(null, "You "
					+ "clicked the third button.");
			}
		}
	}
