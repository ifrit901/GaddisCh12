...
/**
 * This is Code Listing 12-11 which demonstrates 
 * how panels can be nested inside each region of
 * a content pane governed by a BorderLayout manager.
 * 
 * @author craig
 */
public class BorderPanelWindow extends JFrame {
	 ...
	 * the class and causes it to be displayed in 
	 * the window.
	 */
