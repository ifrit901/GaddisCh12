...
/**
 * The MetricConverter class lets the user enter
 * a distance in kilometers. Radio buttons can be 
 * selected to convert the kilometers to miles, feet, 
 * or inches.
 * 
 * @author craig
 */
public class MetricConverter extends JFrame {
	...
	/**
	 * The buildPanel method adds a label, text field, and three radio 
	 * buttons to a panel.
	 */
	private void buildPanel() {

		// Create the lable, text field, and radio buttons
	 ...
	 * clicks one of the radio buttons.
	 */
